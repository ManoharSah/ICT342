		...
		<div class="row" style="padding-top: 0px;">
			<div class="col-md-6 col-md-offset-3">
				<div class="well well-sm">
				  ...
				  <p>For example budgeting for technician Holidays (they are away for 4 weeks, so this is the impact to my monthly target in that time)  - Used to Justify pay rise request to business owner (if they leave it costs us this much vs $xx for the pay rise)  - Used to identify the cost of sacking the technician vs the cost of their poor work/return work (ie If we sack them it might cost us $xx, but to keep them on with the mistakes they make costds us $YY)  <a href="" class="green_link" data-toggle="modal" data-target="#myModal" style="font-weight: bold;">View Examples.</a></p>
				</div>
			</div>
			<div class="col-md-6 col-md-offset-3">
